...
1. Check the two app services: ```systemctl status mupibox-server mupibox-player```
   (bis 14.08.2026 stand hier ```pm2 status``` — die Dienste laufen seit dem
   29.07.2026 unter systemd, und pm2 wird nicht mehr installiert)
