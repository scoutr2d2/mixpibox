...
# HIER STAND das Umhaengen des Farbthema-Symlinks (active_theme.css ->
# themes/<mupibox.theme>.css, mit dem dokumentierten Teilstring-Vergleich,
# llmwiki: mupi-themawechsel-teilstring). Gefallen mit E118/1e: die alte
# Oberflaeche und ihre CSS-Themen sind geloescht; die neue faerbt ueber
# /farben.css aus einer festen Datei (E118/1c, kein Symlink, kein sudo).
